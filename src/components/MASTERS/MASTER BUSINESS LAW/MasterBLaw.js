...
import MasterBLawDetails from "./MasterBLawDetails";
import MasterBLawMain from "./MasterBLawMain";
					...
					<div className="">
						<div className=" lg:w-full    ">
							<div className=" bg-gray-100 lg:px-8 px-3 py-3 pb-10  ">
								...
								{/* programs summary  ended here */}
							</div>
						</div>
					</div>
					{/* programs main  added */}
					<div className="">
						<MasterBLawMain></MasterBLawMain>
					</div>
				</div>
				{/* programs details  added */}
				<div className="container lg:mr-52 ">
					<MasterBLawDetails></MasterBLawDetails>
				</div>
			</div>
		</div>
	);
