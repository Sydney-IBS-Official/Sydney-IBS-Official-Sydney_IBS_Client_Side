								...
								<div className=" bg-gray-100 lg:px-8 px-3 py-3 pb-10  ">
									...
									<div className="  ">
										...
										<p className=" lg:px-20 px-3 text-justify mt-3 ">
											...
											candidates are required to complete 36 units of credit
											worth of coursework units, usually during their first 18
											months of study, to assist them in completing their
											dissertation. PhD candidates are required to submit a
											...
											duration vary by discipline. You should carefully review
											all discipline-specific information before applying for
											entry to a PhD program.
										</p>
										<p className="text-justify mt-3 lg:px-20 px-3">
											Our doctoral training will engage you in numerous aspects
											of academic life. You will be both a student and a junior
											research colleague. We provide courses in a wide variety
											of research methods, and you will work closely with your
...
export default DiplomaEconomics;
