							...
							<div className=" bg-gray-100 lg:px-8 px-3 py-1 pb-10  ">
								...
								<div className="  " id="Research">
									...
									<p className=" lg:px-20 px-3 text-justify mt-3 ">
										<div className="">
											<p className="mt-2">
												diploma candidates at the Sydney Islamic Business School
											...
											<div className="mt-3">
												<p>
													<a
														href="/diplomafinance"
														className="hover:text-blue-700   underline hover:underline-offset-4"
													>
								...
								<div className=" mt-5 " id="structure">
									...
									<p className=" lg:px-20 px-3 text-justify mt-3 ">
										<div className="">
											<p className="mt-2">
												The diploma program consists of two components–
											...
											<p>
												...
												to take. At the same time, diploma candidates will
											...
											<p>
												diploma candidates are required to submit a draft thesis
											...
											<p>
												The culmination of the diploma in Islamic Business is a
								...
								<div className="  " id="Admission">
									...
									<p className=" lg:px-20 px-3 text-justify mt-3 ">
										The admission requirements for the diploma program reflect
									...
									<p className="lg:px-20 px-3 text-justify mt-3">
										(ii) another qualification (e.g. a diploma degree) with a
									...
									<p className="lg:px-20 px-3 text-justify mt-3">
										Admission to the diploma program is competitive and we can
									...
									<p className="lg:px-20 px-3 text-justify mt-3">
										...
										into the diploma program, you might consider applying to the
									...
									<ul className="lg:px-20 px-3 text-justify mt-3">
										<li>
											...
											motivation to undertake a diploma in Islamic Business at
											Sydney IBS
										</li>
										<li>
								...
								<div className="  " id="outcome">
									...
									<p className=" lg:px-20 px-3 text-justify mt-3 ">
										Through the completion of the diploma in Islamic Business at
										Sydney IBS:
									</p>
									<ul className="lg:px-20 px-3 text-justify mt-3 ">
										<li>
