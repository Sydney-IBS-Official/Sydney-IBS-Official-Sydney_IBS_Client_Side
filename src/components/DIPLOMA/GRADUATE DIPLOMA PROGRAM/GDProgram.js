...
import GDProgramDetails from "./GDProgramDetails";
import GDProgramMain from "./GDProgramMain";
		...
		<div className="">
			...
			<div className="container mx-auto  lg:mb-16 lg:mt-7 ">
				<div className="lg:mx-[100px] shadow">
					...
					<div className="">
						<GDProgramMain></GDProgramMain>
					</div>
				</div>
				{/* Program details added here */}
				<div className="container lg:mr-52 ">
					<GDProgramDetails></GDProgramDetails>
				</div>
			</div>
		</div>
	);
