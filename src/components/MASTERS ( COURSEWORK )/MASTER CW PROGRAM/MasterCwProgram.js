...
import MasterCwProgramDetails from "./MasterCwProgramDetails";
import MasterCwProgramMain from "./MasterCwProgramMain";

const MasterCwProgram = () => {
	return (
		<div className="">
				...
				<div className="lg:mx-[110px] shadow">
					...
					<div className="text-md breadcrumbs md:px-6   lg:mx-[85px] ">
						<ul className="text-sky-700 ">
							...
							<li>
								<a href="/masterscoursework">Master (Coursework)</a>
							</li>
							<li>
								<p className="text-black">Master( Coursework) Program</p>
							</li>
						</ul>
					</div>
					{/*  breadcrumbs ended */}
			...
			<div className="container mx-auto  lg:mb-16 lg:mt-7 ">
				<div className="lg:mx-[110px] shadow">
						...
						<div className=" lg:w-full    ">
							<div className=" bg-gray-100 lg:px-8 px-3 py-3 pb-10  ">
								<h1 className="text-sky-700 text-xl font-bold lg:px-20 px-3 ">
									Master(Islamic Business- Coursework)
								</h1>
					...
					<div className="">
						<MasterCwProgramMain></MasterCwProgramMain>
					</div>
				</div>

				{/* program details component added here  */}
				<div className="container lg:mr-52 ">
					<MasterCwProgramDetails></MasterCwProgramDetails>
				</div>
			</div>
		</div>
	);
...
export default MasterCwProgram;
