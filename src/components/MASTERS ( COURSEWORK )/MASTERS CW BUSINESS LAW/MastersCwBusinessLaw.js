...
import MastersCwBusinessLawDetails from "./MastersCwBusinessLawDetails";
import MastersCwBusinessLawMain from "./MastersCwBusinessLawMain";
import MastersCwBusinessLawSidebar from "./MastersCwBusinessLawSidebar";

const MastersCwBusinessLaw = () => {
	return (
		<div>
				...
				<div className="lg:mx-[100px]">
					<div className="grid   lg:grid-cols-2 sm:grid-cols-1">
						...
						<div className="lg:ml-[200px] mt-4">
							<MastersCwBusinessLawSidebar></MastersCwBusinessLawSidebar>
						</div>
					</div>
					<div>
						<MastersCwBusinessLawMain></MastersCwBusinessLawMain>
					</div>
				</div>
				<div className="container lg:mr-52">
					<MastersCwBusinessLawDetails></MastersCwBusinessLawDetails>
				</div>
			</div>
		</div>
	);
...
export default MastersCwBusinessLaw;
