...
import MastersCwEconomicsDetails from "./MastersCwEconomicsDetails";
import MastersCwEconomicsMain from "./MastersCwEconomicsMain";
import MastersCwEconomicsSidebar from "./MastersCwEconomicsSidebar";

const MastersCwEconomics = () => {
	return (
		<div>
				...
				<div className="lg:mx-[100px]">
					<div className="grid   lg:grid-cols-2 sm:grid-cols-1">
						...
						<div className="lg:ml-[200px] mt-4">
							<MastersCwEconomicsSidebar></MastersCwEconomicsSidebar>
						</div>
					</div>
					<div>
						<MastersCwEconomicsMain></MastersCwEconomicsMain>
					</div>
				</div>
				<div className="container lg:mr-52">
					<MastersCwEconomicsDetails></MastersCwEconomicsDetails>
				</div>
			</div>
		</div>
	);
...
export default MastersCwEconomics;
