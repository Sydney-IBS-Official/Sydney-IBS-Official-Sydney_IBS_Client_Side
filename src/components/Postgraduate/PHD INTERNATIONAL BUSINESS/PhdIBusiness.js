...
import PhdIBusinessDetails from "./PhdIBusinessDetails";
import PhdIBusinessMain from "./PhdIBusinessMain";
		...
		<div className="">
				...
				<div className="lg:mx-[110px] shadow">
					...
					<div className="text-md breadcrumbs md:px-6   lg:mx-[85px] ">
						<ul className="text-sky-700 ">
							...
							<li>
								<p className="text-black"> PhD International Business</p>
							</li>
						</ul>
					</div>
					{/*  breadcrumbs ended */}
			...
			<div className="container mx-auto  lg:mb-16 lg:mt-7 ">
				<div className="lg:mx-[110px] shadow">
					...
					<div className="">
						<PhdIBusinessMain></PhdIBusinessMain>
					</div>
				</div>
				{/* course details content added */}
				<div className="container lg:mr-52 ">
					<PhdIBusinessDetails></PhdIBusinessDetails>
				</div>
			</div>
		</div>
	);
