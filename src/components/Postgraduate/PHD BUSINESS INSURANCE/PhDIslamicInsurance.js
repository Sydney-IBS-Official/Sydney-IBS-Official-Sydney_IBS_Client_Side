...
import PhDInsuranceDetails from "./PhDInsuranceDetails";
import PhdIslamicInsuranceMain from "./PhdIslamicInsuranceMain";

const PhDIslamicInsurance = () => {
	return (
		<div className="">
				...
				<div className="lg:mx-[110px] shadow">
					...
					<div className="text-md breadcrumbs md:px-6   lg:mx-[85px] ">
						<ul className="text-sky-700 ">
							...
							<li>
								<p className="text-black"> PhD Islamic Insurance</p>
							</li>
						</ul>
					</div>
					{/*  breadcrumbs ended */}
						...
						<div className=" lg:w-full    ">
							<div className=" bg-gray-100 lg:px-8 px-3 py-3 pb-10  ">
								<h1 className="text-sky-700 text-xl font-bold lg:px-20 px-3 ">
									Doctor of Philosophy (Islamic Insurance)
								</h1>
							...
							{/* Program summary ended */}
						</div>
					</div>

					{/* course main content added */}
					<div className="">
						<PhdIslamicInsuranceMain></PhdIslamicInsuranceMain>
					</div>
				</div>
				{/* course details added */}
				<div className="container lg:mr-52 ">
					<PhDInsuranceDetails></PhDInsuranceDetails>
				</div>
			</div>
		</div>
	);
...
export default PhDIslamicInsurance;
