							...
							<div className=" bg-gray-100 lg:px-8 px-3 py-1 pb-10  ">
								...
								<div className=" mt-5 " id="structure">
									...
									<p className=" lg:px-20 px-3 text-justify mt-3 ">
										<div className="">
											...
											<p>
												The culmination of the master in Islamic Business is a
								...
								<div className="  " id="Admission">
									...
									<p className="lg:px-20 px-3 text-justify mt-3">
										...
										into the master program, you might consider applying to the
									...
									<ul className="lg:px-20 px-3 text-justify mt-3">
										<li>
											...
											motivation to undertake a master in Islamic Business at
											Sydney IBS
										</li>
										<li>
								...
								<div className="  " id="outcome">
									...
									<p className=" lg:px-20 px-3 text-justify mt-3 ">
										Through the completion of the master in Islamic Business at
										Sydney IBS:
									</p>
									<ul className="lg:px-20 px-3 text-justify mt-3 ">
										<li>
...
export default MasterprogramDetails;
