...
const Apply = () => {
    ...
    <div className="accordion container mx-auto ">
      <div className="lg:mx-[170px] shadow-md bg-base-100">
        {/* breadcrumb use here */}
        <div className="text-md breadcrumbs md:px-6  lg:mx-5 px-3   ">
          ...
          <div className="">
            ...
            <p className="mb-3 text-justify">
              ...
              All correct and satisfactory documents must be fully submitted
              with the application, including English translations, Financial
            ...
            <p className="mb-10 text-md text-justify">
        ...
        <div className="mx-6">
          ...
          <div className=" lg:mx-3">
            <p
              ...
              className="accordion-visible  text-sky-700 mb-3 border-t "
            >
            ...
            {step1 && (
              <div>
                <div
                  aria-hidden={step1 ? 'true' : 'false'}
                  className=" lg:mx-4 px-3"
                >
                  <p className="mb-5 text-justify">
                    There are a number of eligibility requirements you ensure
                    you meet prior to applying for a Higher Research Degree.
                    These include the following.
                  </p>
                  <div className="">
                    {' '}
                    <li className="text-justify mb-3">
                      Admission and scholarship application minimum
                      requirements: visit{' '}
                    ...
                    <li className="text-justify mb-3">
                      ...
                      any dependants) for the duration of your studies and, if
                      an international applicant, that you are a
                      <span className="text-sky-700 font-bold cursor-pointer hover:underline">
                        {' '}
                    ...
                    <li className="text-justify mb-3">
                      ...
                      must be provided by a potential supervisor or School
                      before you can apply. Further checks on{' '}
                      <span className="text-sky-700 font-bold cursor-pointer hover:underline">
                        {' '}
                    ...
                    <li className="text-justify mb-3">
                      ...
                      requirements, please see your Faculty’s website for
                      further details
                    </li>
                  </div>
                </div>
          ...
          <div className="lg:mx-3">
            ...
            {step2 && (
              <div>
                <div
                  aria-hidden={step2 ? 'true' : 'false'}
                  className="lg:mx-4 px-3"
                >
                  <p className="text-justify mb-3">
                    Finding a supervisor with compatible research interests and
                    working styles is critical to your success as a Higher
                    Degree Research candidate.
                  </p>
                  <p className="text-justify mb-3">
                    Most Faculties/Schools require applicants to contact
                    potential supervisors. See the{' '}
                    <span className="text-sky-700 font-bold cursor-pointer hover:underline">
                      {' '}
                  ...
                  <p className="text-justify mb-3">
                    ...
                    appropriate resources will be available. The interview can
                    be face-to-face or via Skype (or other such video
                    messaging).
                  </p>
                  <p className="text-justify mb-3">
          ...
          <div className="lg:mx-3">
            <p
              ...
              className="accordion-visible text-sky-700 mb-3 border-t flex "
            >
            ...
            {step3 && (
              <div>
                <div
                  aria-hidden={step3 ? 'true' : 'false'}
                  className="lg:mx-4 px-3"
                >
                  <p className="mb-3 text-justify">
                    Before you apply, prepare your supporting documentation as
                    per the
                    <span className="text-sky-700 font-bold cursor-pointer hover:underline">
                      {' '}
                  ...
                  <p className=" text-justify mb-3">
                    Specific scholarship schemes, research programs, or
                    Faculties may require additional documents not listed above,
                    and these may be requested after the initial application.
                    Visit your Faculty website below for guidance.
                  </p>
                  <p className="text-justify mb-3">
                    You may submit scanned copies of your documents with your
                    application. Documents may be verified at a later date,
                    either with your home institution, or by sighting original
              ...
              <div>
                ...
                >
                  ...
                  <div className="mx-10">
                    ...
                    <li className="mb-3">
                      Proof of accreditation, including name and membership
                      number
                    </li>
              ...
              <div>
                ...
                >
                  <p className="my-3 text-justify">
                    ...
                    before submitting an application. Scholarship applicants
                    must do so before the scholarship deadline (see Key Dates).
                  </p>
                  <p className="mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm mb-3">
                      ...
                      *All English waiver requests must be approved by the
                      ...
                      waiver requests must be submitted at least 6 weeks prior
                      to the due date.
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:mx-3">
            ...
            {step6 && (
              <div>
                <div
                  aria-hidden={step6 ? 'true' : 'false'}
                  className="lg:mx-4 px-3 "
                >
                  <p className="my-3 text-justify">
                    Once you have secured a supervisor, held your interview,
                    developed a research description, and prepared your
                    supporting documents, you are ready to{' '}
                    <span className="text-sky-700 font-bold cursor-pointer hover:underline">
          ...
          <div className="lg:mx-3">
            ...
            {step7 && (
              <div>
                <div
                  aria-hidden={step7 ? 'true' : 'false'}
                  className="lg:mx-4 px-3"
                >
                  <p className="my-3 text-justify">
                    It will take 4 working days for your application to be
                    processed after you submit it. Once processed, you’ll
                    receive an email confirmation with a SYDNEY IBS Student ID.
                    If you have any outstanding documentation, these will also
                    be listed in your confirmation email.
                  </p>
                  <p className="mb-3 text-justify">
                  ...
                  <h1 className="mb-3 text-lg text-black font-bold text-justify">
                  ...
                  <p className="mb-3 text-justify">
                    ...
                    admission only, the outcome would typically take 6-8 weeks
                    to be processed.
                  </p>
                  ...
                  <p className="my-3 text-justify">
                    ...
                    status of each document once it has been checked. We
                    recommend that you check this document tracking to ensure
                    that you have submitted all required documentation.
                  </p>
            ...
            {step8 && (
              <div>
                <div aria-hidden={step8 ? 'true' : 'false'} className="mx-4">
                  <p className="my-3">
                    If you have met the requirements, you will receive a letter
                    of offer to study at SYDNEY SIBS.
                  </p>
              ...
              <div>
                <div aria-hidden={step9 ? 'true' : 'false'} className="mx-4">
                  <p className="my-3">
                    ...
                    , therefore you must ensure you respond to your offer early
                    to allow enough time to arrive by that date.
                  </p>
                  ...
                  <p>
                    ...
                    HDR Scholarship offers may be able to be deferred on a case
                    by case basis (check your scholarship letter for details).
                  ...
                  <div>
                    ...
                    <p className="mt-3">
                      Please ensure you have already submitted any extra
                      required documentation prior to requesting deferral.
                    </p>
                  </div>
                  ...
                  <p className="mb-3">
                    ...
                    accepted through Apply Online. Outstanding documentation
                    must be provided prior to a full offer being issued.
                  </p>
                  <p className="mb-3">
                    <span className="text-black  font-bold">
                      Sponsored applicants:{' '}
                    </span>{' '}
                    Sponsored applicants must accept their offer by completing
                    and emailing the admission offer reply forms, International
                    Sponsored Student Agreement form, and financial guarantee
                    from your sponsor as per your offer letter
                  </p>
                  <div>
                    ...
                    <p className="mb-3 mt-3">
                      ...
                      Accept or defer your offer of admission and scholarship
                      (if applicable) in Accept Online to ensure your place in
                      the program. As part of this process, unless accepting an
                    ...
                    <p>
                      ...
                      Student Declaration sections. Part II must only be
                      completed once you are ready to arrive and enrol
                      (including for International applicants, being granted the
                      student visa and arriving in Australia). Acceptance
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      recipients must accept or defer within 1 month of
                      receiving the unconditional offer.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      Confirmation of Enrolment (CoE) will be issued to you
                      within the following fortnight. You will need to use this
                      to apply for a visa.{' '}
                    </p>
                    <p className="mt-3 mb-5">
                      Before proceeding with the next steps, you must arrive at
                      your study location, and if you are International, must
                      hold on an appropriate visa for the full length of study.
                      If you are not able to meet these requirements prior to
                      the{' '}
              ...
              <div>
                <div aria-hidden={step10 ? 'true' : 'false'} className="mx-4">
                  <p className="my-3">
                    ...
                    international travel concierge service can help you plan
                    your trip, including:
                  </p>
                  ...
                  <div className="mx-3">
                    ...
                    <li>
                      {' '}
                      keeping up-to-date with the latest COVID-19 measures
                    </li>
                  </div>
            ...
            {step11 && (
              <div>
                <div aria-hidden={step11 ? 'true' : 'false'} className="mx-4">
                  <p className="my-3">
                    Have questions about applying for admission or a
                    scholarship?{' '}
                    <span className="text-sky-700 font-bold cursor-pointer hover:underline">
                      Visit this page
                    </span>{' '}
