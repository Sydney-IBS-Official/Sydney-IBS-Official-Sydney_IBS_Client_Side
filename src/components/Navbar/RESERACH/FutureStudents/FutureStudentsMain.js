      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10  lg:grid-cols-3 ">
          ...
          <figure>
            <a href="/phd">
              <img
                src={image1}
                alt="image1"
                className="lg:h-[190px] lg:w-[350px] md:w-[350px] md:h-[185px]"
              />
            </a>
          </figure>
          <div className=" mt-3">
            ...
            <p className="text-black text-md ">
              Academic leadership and oversight of all Higher Degree Research
              Programs at SIBS
            </p>
          </div>
        </div>
        ...
        <div className=" ">
          ...
          <div className="mt-3">
            ...
            <p className="text-black text-md">
              Resources, workshops and communities to help you make the most of
              your time at SIBS
            </p>
          </div>
        </div>
        ...
        <div className=" ">
          ...
          <div className="mt-3">
            ...
            <p className="text-black text-md">
              At SIBS, we recognise that a safe and healthy University supports
              research success.
            </p>
          </div>
        </div>
          ...
          <a href="/apply">
            <figure>
              <img
                src={image4}
                alt="image4"
                className="lg:h-[190px] md:w-[350px] md:h-[185px] lg:w-[350px]"
              />
            </figure>
          </a>
          <div className="mt-3">
