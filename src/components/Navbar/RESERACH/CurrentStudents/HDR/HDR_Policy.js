                ...
                <div className="lg:mx-20 ">
                  ...
                  <div className="flex gap-1  px-2">
                    ...
                    <p className="text-justify mb-2">
                      ...
                      ></FontAwesomeIcon>
                      - Policy on doctorate program admission, English language
                      requirements, progress reports, requirements of the degree
                      and examinations.
                    </p>
                  </div>
                  <div className="flex gap-1  px-2">
                    ...
                    <p className="text-justify mb-2">
                      ...
                      <FontAwesomeIcon
                        ...
                        className="h-6 w-2.5 px-1 text-sky-700  "
                      ></FontAwesomeIcon>
                      - Policy on masters program admission, English language
                      requirements, progress reports, requirements of the degree
                      and examinations.Policy on degrees awarded by two
                      universities.
                    </p>
                  </div>
                  <div className="flex gap-1  px-2">
                  ...
                  <div className="flex gap-1  px-2">
                    ...
                    <p className="text-justify mb-2">
                      ...
                      <FontAwesomeIcon
                        ...
                        className="h-6 w-2.5 px-1 text-sky-700  "
                      ></FontAwesomeIcon>
                      - This policy details the key responsibilities of all
                      sections of the University in meeting work and
                      occupational health and safety legal obligations.
                    </p>
                  </div>
                </div>
              </div>
